  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to RajShree Emporium. You can now sign in.",
      });
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-2 mb-4">
            ...
            <span className="heading-section text-3xl">RajShree Emporium</span>
          </div>
          <p className="text-elegant">Join our family of style enthusiasts</p>
        </div>
        ...
        <Card className="card-elegant">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Sign up to discover amazing ethnic wear collections
            </CardDescription>
          </CardHeader>
